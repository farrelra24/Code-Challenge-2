...
function OurServices() {
  return (
    <>
      ...
      <div className="bg-white h-[1450px] lg:h-[850px] flex flex-col justify-center items-center">
        <div className="text-center">
        ...
        <div className="flex gap-8">
          ...
          <div className="bg-base-100 h-[558px] w-[192px] p-7 lg:h-[278px] lg:w-[445px]">
            ...
            <p className="text-[15px] text-gray-500">
              Kami ahli dalam jasa pasang Umbul-Umbul, Spanduk, Baliho,
              Billboard, Sticker, dan lain-lain. Kami juga memberikan garansi
              pemasangan pada media iklan yang sedang tayang.
            </p>
          </div>
          <div className="bg-base-100 h-[558px] w-[192px] p-7 lg:h-[278px] lg:w-[445px]">
            <Image
            ...
            <p className="text-[15px] text-gray-500">
              ...
              terjangkau, kami telah dipercaya oleh perusahaan maupun
              perseorangan dalam menangani Jasa Perzinan Reklame.
            </p>
          </div>
        </div>
